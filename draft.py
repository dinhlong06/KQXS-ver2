...
from expo_excel import write_to_excel, PROVINCE_CONFIG, open_excel_file
...
class XoSoApp:
    ...
    def show_results(self, date, day_ago=0):
        ...
        # Lấy dữ liệu
        url = (f"https://www.minhngoc.net/ket-qua-xo-so/mien-trung/{date_str}.html" 
           if day_ago != 0 else "https://www.minhngoc.net/xo-so-truc-tiep/mien-trung.html")
    ...
    def export_to_excel(self):
        ...
        # Kiểm tra xem có dữ liệu hợp lệ không (ít nhất 1 giải có kết quả)
        has_valid_data = any(
        ...
        messagebox.showinfo("Thành công", f"Đã xuất kết quả ngày {excel_date} ra file Excel")
